...
[![Verify](https://github.com/jumincho/incoherence-aware-control/actions/workflows/verify.yml/badge.svg)](https://github.com/jumincho/incoherence-aware-control/actions/workflows/verify.yml)
...
- 用**不稳定性(incoherence)信号分配测试时算力确实有效**——在足够大的预算下,准确率与稳定性都优于均匀分配基线。
- 但**效果取决于预算**——预算小时稳定性提升而准确率可能下降("有条件"而非"总是")。
- **未能干净地胜过最强的简单基线**(多次求解后投票);控制器自身的增益没能分离出来。
